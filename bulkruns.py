...
#base_command = 'yt-dlp -P "~/E://Training/Youtube/MyVideos" -o "%(playlist_index)s - %(title)s.%(ext)s"'
base_command = 'yt-dlp -P "~/E://Training/Youtube/MyVideos" -o "%(uploader)s/%(playlist)s/%(playlist_index)s - %(title)s.%(ext)s"'
...
base_command = base_command + ' --cookies "./cookies.txt"'
